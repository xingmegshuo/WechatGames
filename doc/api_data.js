define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "mails",
            "description": "<p>系统邮件和个人游戏内获得邮件</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "title": "知识学习状态",
    "version": "0.0.1",
    "description": "<p>调用此接口会提示用户已经学习此知识，可以去获取新的</p>",
    "name": "知识学习状态",
    "group": "萌游知知",
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "title": "获取知识-更新版",
    "version": "0.0.1",
    "description": "<p>获取学习知识，随机返回一条,获取已学习知识,分页,20条为一页</p>",
    "name": "获取知识-或者获取已经学习的知识",
    "group": "萌游知知",
    "header": {
      "fields": {
        "Header": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "page",
            "description": "<p>获取已经学习过的数据页数，参数可选，不携带默认第一页</p>"
          }
        ]
      }
    },
