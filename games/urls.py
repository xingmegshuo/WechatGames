...
from .views import SignView, KnowView, Ranking, GameInfoView, DirayView, MailboxView, DirayImageView,CodeView,InviterView,InviterNewView
...
urlpatterns = format_suffix_patterns([
    ...
    re_path(r'^code/$',CodeView.as_view()),
    re_path(r'^inviter/$',InviterView.as_view()),
    re_path(r'^inviternew/$',InviterNewView.as_view()),
